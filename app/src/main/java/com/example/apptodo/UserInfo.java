...
import com.example.apptodo.databinding.ActivityUserInfoBinding;
...
public class UserInfo extends AppCompatActivity {
    ...
    private void showLogoutDialog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setBackground(getResources().getDrawable(R.drawable.rounded_button));
        dialog.getButton(DialogInterface.BUTTON_NEGATIVE).setTextColor(getResources().getColor(R.color.dialogTitleColor));
        dialog.getButton(DialogInterface.BUTTON_NEGATIVE).setBackground(getResources().getDrawable(R.drawable.rounded_button));
    }
